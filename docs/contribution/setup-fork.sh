...
# upstream   https://github.com/alexindigo/ProxmoxVED.git (fetch)
# upstream   https://github.com/alexindigo/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/alexindigo/ProxmoxVED"
echo ""
